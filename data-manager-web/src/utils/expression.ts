 ...
 *  @connector 连接符 ||或者 &&
 */
export function getExpression(conditionList: any, connector: any) {
    let exList = conditionList.filter((item: any) => {
 ...
 * 执行表达式是否成立
 */
export function evalExpression(context: any, expression: any) {
