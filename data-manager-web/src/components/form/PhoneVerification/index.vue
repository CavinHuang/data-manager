<template>
    <div class="phone-number-container">
        <el-input
          ...
          maxlength="11"
          placeholder="点击验证手机号" readonly @click="openDialogHandle"
        >
          <template v-slot:prefix >
            <i class="el-input__icon el-icon-mobile" />
          </template>
          <template v-slot:append>
            <el-button icon="el-icon-message" @click="openDialogHandle" />
          </template>
        </el-input>
        <el-dialog v-model="open" title="手机号验证">
